...
import DbConnection.EnrollOperation;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
               HttpSession ses=request.getSession(true);
                 String s=(String)ses.getAttribute("courseid").toString();
                   String emailid=(String)ses.getAttribute("email");
                     ...
                     EnrollBean enroll=new EnrollBean();
                      EnrollOperation eno=new EnrollOperation();
                      enroll.setCourseid(courseid);
                        enroll.setEmailid(emailid);
                          enroll.setQuizscore("not yet");
                  boolean status=eno.enrollform(enroll);
                      if(status){
